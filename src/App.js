...
class App extends React.Component {
  ...
  menos = () => {
    if(!this.state.contando && this.state.minutos !== 0){
      this.setState({
      minutos: this.state.minutos -1
    });
  }
    ...
    return (
      <div style={AppStyle.divDeFora}>
        <div style={AppStyle.divDeDentro}>
          ...
          <div>
            <Botao clique={this.contando ? this.parar : this.iniciar} texto={this.state.contando ? "Stop" : "Start"} tamanho="grande"/>
            <div style={AppStyle.meio}>
